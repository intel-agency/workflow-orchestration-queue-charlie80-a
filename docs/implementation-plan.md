...
>
> **Scope:** Template repo `workflow-orchestration-queue-charlie80-a` only. Issues targeting generated code (sentinel, notifier, queue) are deferred to the implementation phase.
